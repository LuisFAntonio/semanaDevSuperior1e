...
const BASE_URL = 'http://192.168.0.151:8080';
...
const handleSubmit = () => {
    ...
    .catch(() => Alert.alert('Erro ao cadastrar os dados. Tente novamente.'))
}
    ...
    useEffect(() =>{
        ...
        .catch(() => Alert.alert('Erro ao listar os jogos. Verifique a base de dados e tente novamente.'))
    }, [])
